...
class Echo_seg(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return video.squeeze(1), np.expand_dims(target, axis=0), 0, 0
...
if __name__ == '__main__':
    data_loader = Echo(
            root='/data/liujie/data/echocardiogram/EchoNet-Dynamic', split='VAL', target_type="SmallTrace"
        )
